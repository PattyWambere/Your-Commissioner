...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    phone: '',
    role: 'USER' as 'USER' | 'COMMISSIONER',
  })
        ...
        <div className="bg-white rounded-lg shadow-md p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                value={formData.role}
                onChange={(e) => setFormData({ ...formData, role: e.target.value as 'USER' | 'COMMISSIONER' })}
                className="w-full px-3 py-2.5 text-base sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 touch-manipulation"
              >
          ...
          <p className="mt-4 text-center text-sm text-gray-600">
            ...
            <Link href="/login" className="text-primary-600 hover:text-primary-700 touch-manipulation">
              Login
            </Link>
          </p>
        </div>
